...
public class InstrumentationProxy extends Instrumentation {
    ...
    public static final String REQUEST_TARGET_INTENT_NAME = "com.muaj.demo.common.InstrumentationProxy";
    ...
    public ActivityResult execStartActivity(
        ...
        if (null == resolveInfo || resolveInfo.size() == 0) {
            ...
            //设置为占坑Activity
            intent.setClassName(who, "com.muaj.demo.hook.StubActivity");
        }
